# old data format:(prompt, chosen, rejected)
import os
import torch
...
def train_dpo_model(data_path: str, save_path: str):
    ...
    # === Load full dataset (12000 samples) ===
    full_ds = load_dataset("json", data_files={"train": data_path})["train"]
    train_ds = full_ds.select(range(12000))
